...
unsigned char btnPress(void) {  // returns when a button is pressed
    unsigned char btn = 0;      // It does detect and decode multiple buttons pressed
